...
class ProductControllerTest {
        ...
        class CreateProductTests {
                ...
                void whenCreateProduct_thenReturnCreated() {
                        ...
                        when(productService.createProduct(any(Product.class), org.mockito.ArgumentMatchers.eq(1L)))
        ...
        class CreateProductWithImageTests {
                ...
                @Test
                @DisplayName("Should create product with size parameter")
                void whenCreateProductWithSize_thenSizeIsSet() {
                        Product savedProduct = new Product("Suit", "Formal suit", 100.0);
                        savedProduct.setId(3L);
                        savedProduct.setAvailable(true);
